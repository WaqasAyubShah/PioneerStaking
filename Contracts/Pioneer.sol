...
/**
 * @notice Pioneer Governance Token = ERC20 + mint + burn.
 * @author SM Waqas(Wiki)
 */

// SPDX-License-Identifier: GPLv2
contract Pioneer is Context, IERC20  {
    ...
    constructor(
        ...
        string memory name_,
        uint8 decimals_,
        PioneerAccessControls accessControls_,
        address tokenOwner,
    ...
    function setCap(uint _cap, bool _freezeCap) external  {
        require(
            ...
            "Verse.setCap: Sender must be admin"
        );
    ...
    function mint(address tokenOwner, uint tokens) external returns (bool success) {
        require(
            ...
            "Verse.mint: Sender must have permission to mint"
        );
