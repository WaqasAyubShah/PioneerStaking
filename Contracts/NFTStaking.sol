    ...
    */
        ...
        external
    {
        require(
            ...
            "PioneerParentStaking.setRewardsContract: Sender must be admin"
        );
        require(_addr != address(0));
        address oldAddr = address(rewardsContract);
        rewardsContract = IPioneerRewards(_addr);
    ...
    /// @notice Stake all your Cattos NFTs and earn reward tokens. 
    function stakeAll()
        external
    {
